...
class DisableEdge(ReproductionMethod):
    """Creates a DisableEdge mutation as a reproduction method."""
    ...
    def __init__(
        ...
        """Initialies a new DisableEdge reproduction method.
        Args:
